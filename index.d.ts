...
declare global {
  ...
  class b2Contact {
    ...
    GetChildIndexA(): BigInt
    GetFixtureB(): b2Fixture
    GetChildIndexB(): BigInt
  ...
  class b2World {
    ...
    Step(
      timeStep: number,
      velocityIterations: BigInt,
      positionIterations: BigInt
    ): void
    ClearForces(): void
    DrawDebugData(): void
    ...
    GetProxyCount(): BigInt
    GetBodyCount(): BigInt
    GetJointCount(): BigInt
    GetContactCount(): BigInt
    GetTreeHeight(): BigInt
    GetTreeBalance(): BigInt
  ...
  //                   [Ref] b2Transform transform, BigInt childIndex);
  //   void ComputeAABB(b2AABB aabb, [Ref] b2Transform xf, BigInt childIndex);
  ...
  //   boolean RayCast(b2RayCastOutput output, [Ref] b2RayCastInput input, BigInt childIndex);
  ...
  //   [Const, Ref]  GetAABB(BigInt childIndex) : b2AABB;
  //  Dump(BigInt bodyIndex) : void;
  // };
  ...
  // class b2ChainShape {
  //  b2ChainShape() : void;
  //   void CreateLoop(b2Vec2 vertices, BigInt count);
  //   void CreateChain(b2Vec2 vertices, BigInt count);
  //   void SetPrevVertex([Ref] b2Vec2 prevVertex);
  //   void SetNextVertex([Ref] b2Vec2 nextVertex);
  //   void GetChildEdge(b2EdgeShape edge, BigInt index);

  //   attribute b2Vec2 m_vertices;
  //   attribute BigInt m_count;
  ...
  // class JSDraw {
  //  JSDraw() : void;
  //   void DrawPolygon([Const] b2Vec2 vertices, BigInt vertexCount, [Const, Ref] b2Color color);
  //   void DrawSolidPolygon([Const] b2Vec2 vertices, BigInt vertexCount, [Const, Ref] b2Color color);
  ...
  //  b2PolygonShape() : void;
  //   void Set(b2Vec2 vertices, BigInt vertexCount);
  //   void SetAsBox(number hx, number hy);
  //   void SetAsBox(number hx, number hy, [Ref] b2Vec2 center, number angle);
  //  GetVertexCount() : BigInt;
  //   [Const, Ref]  GetVertex(BigInt index) : b2Vec2;
  ...
  //   attribute BigInt m_vertexCount;
  // };
